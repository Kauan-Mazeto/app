                  ...
                  {u.stocks.map(s => (
                    <tr key={s.medicineId} className="border-t border-slate-100">
                      ...
                      <td className="px-3 py-2 text-right">
                        {s.quantity <= 0 ? <span className="px-2 py-1 rounded text-xs bg-red-100 text-red-700 font-semibold">Esgotado</span>
                         : s.quantity <= 5 ? <span className="px-2 py-1 rounded text-xs bg-orange-100 text-orange-700 font-semibold">{s.quantity}</span>
