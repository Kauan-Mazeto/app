          ...
          <div className="space-y-3">
            {prescs
              ...
              .map((r) => (
                <div
                  key={r.id}
                  className="border border-slate-200 rounded-lg p-4 flex justify-between items-start"
                >
                  <div>
                    <div className="font-semibold text-[#1D3557]">
                      {r.medication}
                  ...
                  <div className="text-right">
                    ...
                    <div className="font-mono-nums font-bold text-[#1E4620]">
                      ...
                      {r.adherence_logs?.length || 0} /{" "}
                      {(r.schedule?.length || 1) * 7}
                    </div>
                  </div>
                </div>
              ))}
              ...
              .map((r) => (
                ...
                >
                  ...
                  <span className="text-slate-500">
                    {" "}
                    — encerrado ({r.superseded_at?.slice(0, 10) || "—"})
                  </span>
                </div>
              ))}
          </div>
